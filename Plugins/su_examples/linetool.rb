...
# override the draw_geometry method to make it draw a closer representation
# to what it will really create.
...
#-----------------------------------------------------------------------------
# This function is just a shortcut for activating the line tool
def self.linetool
    Sketchup.active_model.select_tool LineTool.new
end

#-----------------------------------------------------------------------------
# This function is just a shortcut for activating the cylinder tool
def self.cylindertool
