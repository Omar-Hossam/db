...
# load 'su_examples/examplescripts.rb'
...
require 'su_examples/selection.rb'
...
require 'su_examples/contextmenu.rb'
...
require 'su_examples/linetool.rb'
...
def self.setLayer(layerName)
    ...
    # If there is already a Layer with the given name, the add method on the
