...
def self.assign_estimate_to_material
...
def self.compute_cost_estimate
    total_cost = 0.0
...
if( not file_loaded?("su_examples/attributes.rb") )
...
#-----------------------------------------------------------------------------
file_loaded("su_examples/attributes.rb")
