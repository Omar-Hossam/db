...
def self.create_point_at_selected_arc_center
    point = nil
    arc = selected_arc
    if( arc )
...
if( not file_loaded?("su_examples/contextmenu.rb") )
...
file_loaded("su_examples/contextmenu.rb")
